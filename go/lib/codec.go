...
import (
	...
	vesting "github.com/cosmos/amino-js/go/lib/cosmos/cosmos-sdk/x/vesting/types"
...
func RegisterCodec(codec *amino.Codec) {
	...
	// cosmos/cosmos-sdk/x/vesting/types/codec.go
	codec.RegisterConcrete(vesting.MsgCreateVestingAccount{}, CosmosSdkMsgCreateVestingAccount, nil)
